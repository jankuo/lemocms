...
--
-- Host: localhost
-- Generation Time: Nov 09, 2019 at 09:19 AM
...
(1, 'admin', '$2y$12$f51s7AK3JJlwXE4OwRcOIuyg6eQLBel5uee5jgwSQtGPTBW/NQNLO', 1, '994927909@qq.com', '', '18397423845', '127.0.0.1', '0', 1, '/storage/uploads/20190817\\294faa45405fa24da59c311f55ce313f.png', 1482132862, 1567843792),
(2, 'yuege', '$2y$12$f51s7AK3JJlwXE4OwRcOIuyg6eQLBel5uee5jgwSQtGPTBW/NQNLO', 2, '994927909@qq.com', '', '18397423845', '127.0.0.1', '0', 1, '/storage/uploads/20190817\\dc25c2714c46a0d2bee894a7d05eb15f.png', 1535512393, 1571034031),
...
(155, 'Addon', '插件', 1, 1, 0, 1, 'fa fa-apple', '', 0, 50, 1573181931, 1573183182),
(156, 'Addon/index', '插件列表', 1, 1, 0, 1, 'fa fa-align-justify', '', 166, 50, 1573181960, 1573183194);
...
--
ALTER TABLE `lm_admin_log`
  MODIFY `id` bigint(16) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '表id', AUTO_INCREMENT=1965;
...
--
ALTER TABLE `lm_auth_rule`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=275;
