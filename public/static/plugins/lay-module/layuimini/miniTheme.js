...
layui.define(["jquery", "layer"], function (exports) {
    ...
    var miniTheme = {
        ...
        render: function (options) {
            ...
            var bgcolorId = sessionStorage.getItem('lemoBgcolorId');
            if (bgcolorId === null || bgcolorId === undefined || bgcolorId === '') {
                bgcolorId = options.bgColorDefault;
            }
            var bgcolorData = miniTheme.config(bgcolorId);
            var styleHtml = '.layui-layout-admin .header{background-color:' + bgcolorData.headerRight + '!important;}\n' +
                '.header .lemo-header-content>ul>.layui-nav-item.layui-this,.lemo-tool i:hover{background-color:' + bgcolorData.headerRightThis + '!important;}\n' +
        ...
        listen: function () {
            ...
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                layer.open({
                    ...
                    content: html,
                        ...
                        $('.lemo-select-bgcolor').removeClass('layui-this');
                    }
                });
                layer.close(loading);
            });
            ...
            $('body').on('click', '[data-select-bgcolor]', function () {
                ...
                $('.lemo-color .color-content ul .layui-this').attr('class', '');
                $(this).attr('class', 'layui-this');
                sessionStorage.setItem('lemoBgcolorId', bgcolorId);
                miniTheme.render({
